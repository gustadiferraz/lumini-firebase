...
const DEMO_EVALUATIONS = [
  {
    ...
    currentRole: 'Líder de Turno',
    desiredRole: 'Supervisor de Produção',
    supervisorEmail: 'tonicarlos@lumini.com',
    supervisorName: 'Toni Carlos',
    date: '2026-02-15',
    sections: {
  ...
  },
  {
    ...
    currentRole: 'Auxiliar de Qualidade',
    desiredRole: 'Técnico de Qualidade',
    supervisorEmail: 'helciopacheco@lumini.com',
    supervisorName: 'Helcio Pacheco',
    date: '2026-01-28',
    sections: {
      tecnica: [true, true, true, true, false],
      comportamento: [true, true, true, true, true],
      seguranca: [true, true, true, true],
      potencial: [true, true, false]
    },
    stars: 4,
    strengths: 'Ótima disciplina de qualidade e excelente organização.',
    improvements: 'Ampliar domínio estatístico e leitura de indicadores.',
    observations: 'Mantém boa evolução e pode assumir tarefas mais técnicas.',
    percent: 88,
    result: 'recommended'
  }
];
